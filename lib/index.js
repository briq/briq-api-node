...
class Organization {
  ...
  createGroup(group) {
    const endpoint = `/organizations/${encodeURIComponent(this.key)}/groups`;
    return this.client.post({ endpoint, body: group });
  }

  updateGroup(groupId, newGroupValues) {
    const endpoint = `/organizations/${encodeURIComponent(this.key)}/groups/${groupId}`;
    return this.client.put({ endpoint, body: newGroupValues });
  }
  ...
  addUsersToGroup(groupId, usernames) {
    const endpoint = `/organizations/${encodeURIComponent(this.key)}/groups/${groupId}/users`;
    return this.client.post({ endpoint, body: { usernames }});
  }
