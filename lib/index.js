...
class Organization {
  ...
  manageableGroups(userId) {
    const endpoint = `/organizations/${encodeURIComponent(this.key)}/users/${encodeURIComponent(userId)}/manageable-groups`;
    return this.client.get({ endpoint });
  }
...
Client.BASE_URL = 'https://api.givebriq.com/v0';
